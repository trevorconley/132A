...
dropObject =
{
	...
	initTouch: function(e)
	{
		...
		if (target!=null){
			addWidget(dropObject.target_self,pos.x-25,pos.y-25,dropObject.target_self.style.width,dropObject.target_self.style.height,dropObject.target_self.innerHTML);
